...
const Alquiler = () => {
  ...
  useEffect(() => {
    ...
    axios.get('http://192.168.1.2/app/bliblioteca/public/api/libros')
      .then((response) => {
    ...
    axios.get('http://192.168.1.2/app/bliblioteca/public/api/clientes')
      .then((response) => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post('http://192.168.1.2/app/bliblioteca/public/api/prestamo', data);
