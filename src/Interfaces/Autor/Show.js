...
const Show = () => {
  ...
  const getData=async()=>{let response=await axios.get('http://192.168.1.20/app/bliblioteca/public/api/autores') 
 ...
 /**el get data esta obteniendo autores y van sumando cada que se crea */
  ...
  const updateAuthor = async () => {
    try {
      ...
      await axios.put(`http://192.168.1.20/app/bliblioteca/public/api/autor/${editingAutor.id}`, {
